...
public class directMessage extends javax.swing.JFrame {
     ...
     */
    public directMessage(int index, Cliente cliente) {
        initComponents();
    ...
    private void sendMessageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendMessageActionPerformed
        if (!this.inputMessage.getText().equals("")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(directMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new directMessage(0, new Cliente()).setVisible(true);
            }
        });
    }
